...
namespace UserCase
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "UserCase", Version = "v1" });
            });
            services.AddDatabase(Configuration.GetConnectionString("PostgreSQL"));
            services.AddRepositories();
            services.AddServices();
            services.AddCustomAuthentication(Configuration);
            services.AddMvc().AddFluentValidation(fv => fv.RegisterValidatorsFromAssemblyContaining<UserRegisterValidator>());
